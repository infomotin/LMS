                        ...
                        <form method="POST" action="{{ route('register') }}" class="pt-4">
                                ...
                                <div class="input-box">
                                    ...
                                    <div class="form-group">
                                        <input class="form-control form--control" type="text" name="f_name" id="f_name"  placeholder="First name" autofocus>
                                ...
                                <div class="input-box">
                                    ...
                                    <div class="form-group">
                                        <input class="form-control form--control" type="text" name="l_name" id="l_name" placeholder="Last name">
                                        <span class="la la-user input-icon"></span>
                                    </div>
                                </div><!-- end input-box -->
                                <div class="input-box">
                                ...
                                <div class="btn-box">
                                    ...
                                    <p class="pt-2 fs-14">Already have an account? <a href="{{ route('login') }}" class="text-color hover-underline">Log in</a></p>
                                </div><!-- end btn-box -->
                        </form>
                    </div><!-- end card-body -->
                </div><!-- end card -->

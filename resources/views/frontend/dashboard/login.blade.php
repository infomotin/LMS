                            ...
                            <form method="POST" action="{{ route('login') }}" class="pt-4">
                                ...
                                <div class="input-box">
                                    ...
                                    <div class="form-group">
                                        <input class="form-control form--control" type="email" name="email" id="email" :value="old('email')" required autofocus autocomplete="username">
                                ...
                                <div class="input-box">
                                    ...
                                    <div class="mb-3 input-group">
                                        ...
                                        <input class="form-control form--control password-field" type="password" id="password"
                                ...
                                <div class="btn-box">
                                    ...
                                    <p class="pt-2 fs-14">Don't have an account? <a href="sign-up.html"

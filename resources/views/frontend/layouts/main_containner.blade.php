...
======================================-->
 ...
 <!--======================================
     START COURSE AREA
======================================-->
 @include('frontend.components.courses_one')
 <!-- end courses-area -->
 <!--======================================
     END COURSE AREA
======================================-->
 ...
 <!-- ================================
    START FUNFACT AREA
================================= -->
 @include('frontend.components.funfact')
 <!-- end funfact-area -->
 <!-- ================================
    START FUNFACT AREA
================================= -->
...
================================= -->
 @include('frontend.components.client_logo')
...
======================================-->
 @include('frontend.components.get_started')
...
======================================-->
 @include('frontend.components.subscriber')
 <!-- end subscriber-area -->
 <!--======================================
     END SUBSCRIBER AREA
======================================-->
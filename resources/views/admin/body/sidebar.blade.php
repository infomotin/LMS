<div class="sidebar-wrapper" data-simplebar="true">
    ...
    <ul class="metismenu" id="menu">
        ...
        <li>
            ...
            <ul>
                <li> <a href="{{route('admin.instructor.index')}}"><i class='bx bx-radio-circle'></i>Instrator</a>
                </li>
                <li> <a href="{{route('admin.student.index')}}"><i class='bx bx-radio-circle'></i>Student</a>
                </li>
